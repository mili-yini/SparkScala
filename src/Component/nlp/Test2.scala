...
object Test2 {
  def main(args: Array[String]): Unit = {
    ...
    val text2=new Text("习近平强调，要始终重视“三农”工作，持续强化重农强农信号；要准确把握新形势下“三农”工作方向，深入推进农业供给侧结构性改革；要在确保国家粮食安全基础上，着力优化产业产品结构；要把发展农业适度规模经营同脱贫攻坚结合起来，与推进新型城镇化相适应，使强农惠农政策照顾到大多数普通农户；要协同发挥政府和市场“两只手”的作用，更好引导农业生产、优化供给结构；要尊重基层创造，营造改革良好氛围。")
    val conf = new SparkConf()
    conf.setAppName("LabelTags")
